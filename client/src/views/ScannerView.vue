<template>
  <div class="min-h-screen w-full flex bg-[#030712] text-slate-200 font-sans overflow-hidden selection:bg-indigo-500/30">
    ...
    <div v-show="!isFullScreen" class="w-80 flex-shrink-0 flex flex-col border-r border-slate-800/60 bg-[#0B0F19] relative z-20 shadow-2xl transition-all flex-grow-0">
      <!-- Header -->
      <div class="p-6 border-b border-slate-800/60 bg-gradient-to-b from-slate-900 to-transparent flex items-center justify-between group cursor-pointer hover:bg-white/5 transition-colors" @click="router.push('/')">
        <div>
        ...
        <div class="p-2 rounded-lg bg-white/5 border border-white/10 opacity-0 group-hover:opacity-100 transition-all">
